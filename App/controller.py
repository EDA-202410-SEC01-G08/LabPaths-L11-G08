...
def searchPaths(analyzer, initialStation, searchMethod):
    ...
    """
    # TODO Hecho Lab 11, conectar con la funcion del model searchPaths
...
def hasSearchPath(analyzer, destStation, searchMethod):
    ...
    """
    # TODO Hecho Lab 11, conectar con la funcion del model hasSearchPath
...
def searchPathTo(analyzer, destStation, searchMethod):
    ...
    """
    # TODO Hecho Lab 11, conectar con la funcion del model searchPathTo
